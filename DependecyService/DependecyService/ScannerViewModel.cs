...
namespace DependecyService
{
    public class ScannerViewModel : BaseViewModel
    {
        ...
        async Task ScanCode()
        {
            //tipos de codigos barra o qr permitidos
            ...
            //superpisicion de linea roja y comentarios
            var overlay = new ZXingDefaultOverlay
            {
                ShowFlashButton = false,
                TopText = "Coloque el codigo de barras frente al dispositivo",
                BottomText = "El escaneo se realiza de manera automatica",
                Opacity = 0.75
            };

            overlay.BindingContext = overlay;

            //superposicion de la nueva pagina en toda la pantalla
